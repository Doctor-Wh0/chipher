//Angular Starter App
var main = angular.module("main", ['ngResource','ui.router','ngRoute', 'ngSanitize'])
...
main.config([
    ...
    function ($stateProvider, $urlRouterProvider,$rootScope, $rootScopeProvider) {
        ...
        $stateProvider
            ...
            .state('vigenere',{
                ...
                controller: 'VigenerController',
                caseInsensitiveMatch: true

            })
            .state('adfgvx',{
                url:'/adfgvx',
                templateUrl: 'adfgvx.html',
                controller: 'AdfgvxController',
                caseInsensitiveMatch: true
            })
            .state('diffihelman',{
                url:'/diffihelman',
                templateUrl:'diffihelman.html',
                controller: 'DiffiHelmanController',
                caseInsensitiveMatch: true
            })
            .state('gammirovanie',{
                url:'/gammirovanie',
            ...
            .state('analitical',{
                url:'/analitical',
                templateUrl:'Analitical.html',
                controller: 'AnaliticalController',
                caseInsensitiveMatch: true
            })  }
]);
